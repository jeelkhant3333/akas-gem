export default function Header({ tab, setTab, recordCount }) {
    ...
    return (
      <header className="bg-primary px-8 flex items-center justify-between sticky top-0 z-100 shadow-[0_2px_8px_rgba(53,73,107,0.25)] h-14.5 max-[900px]:px-4">
        <div className="flex items-center gap-2.5">
          <div className="w-7.5 h-7.5 bg-accent [clip-path:polygon(50%_0%,100%_38%,82%_100%,18%_100%,0%_38%)]" />
